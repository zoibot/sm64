...
enum BingoObjectiveType
{
    ...
    BINGO_OBJECTIVE_RIDE_SHELLS,
    BINGO_OBJECTIVE_TAKE_WARPS,
    BINGO_OBJECTIVE_COLLECTABLE_MAX = BINGO_OBJECTIVE_TAKE_WARPS,
    // End
    BINGO_OBJECTIVE_TYPE_MAX = BINGO_OBJECTIVE_COLLECTABLE_MAX,
    BINGO_OBJECTIVE_TOTAL_AMOUNT
};

// ideas: chuckya, toads, castle secret stars
...
enum BingoObjectiveIcon {
    ...
    BINGO_ICON_RIDE_SHELLS,
    BINGO_ICON_CASTLE_SECRET_STAR,
    BINGO_ICON_TAKE_WARPS,
};
...
enum BingoObjectiveUpdate
{
    ...
    BINGO_UPDATE_RODE_SHELL,
    BINGO_UPDATE_TOOK_WARP,
